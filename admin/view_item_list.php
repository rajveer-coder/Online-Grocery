...
<p>
<h3 class="inner-tittle two">Item List</h3>
<a href="additem.php"> <button class="btn btn-pill btn-primary">Add New Item </button></a>
<div class="form-body">
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
  ...
  ?>
    <tr>
      ...
      <td>
         <a href="myphp.php?edit=yes&id=<?=$elecid?>">
